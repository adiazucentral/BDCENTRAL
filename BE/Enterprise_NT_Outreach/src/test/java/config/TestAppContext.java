...
import net.cltech.outreach.start.StartApp;
...
{
    "net.cltech.outreach.dao.impl.postgresql",
    "net.cltech.outreach.service.impl.enterprisent",
    "net.cltech.outreach.controllers"
})
