 ...
 */
package net.cltech.outreach.dao.impl.sqlserver.exception;
 ...
 */
@Repository
public class ExceptionDaoSQLServer implements ExceptionDao
{
    ...
    public WebException insert(WebException exception) throws Exception
    {
        SimpleJdbcInsert insert = new SimpleJdbcInsert(jdbc)
                ...
                .usingColumns("lab151c2", "lab151c3", "lab151c4", "lab151c5", "lab151c6", "lab151c7", "lab04c1", "lab04c5");
    ...
    public List<WebException> get(Timestamp initialDate, Timestamp finalDate) throws Exception
    {
        return jdbc.query(""
                ...
                new RowMapper<WebException>()
                {

                    @Override
                    public WebException mapRow(ResultSet rs, int i) throws SQLException
                    {
