...
public class ResultTestHistory {
    ...
    @ApiObjectField(name = "entryDate", description = "Fecha de ingreso", required = false, order = 13)
    private Date entryDate;
    @ApiObjectField(name = "resultComment", description = "Comentario del resultado", required = false, order = 14)
