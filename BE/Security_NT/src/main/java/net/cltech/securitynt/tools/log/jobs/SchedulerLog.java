 ...
 */
package net.cltech.securitynt.tools.log.jobs;
...
/**
 * Representa el log para el hijo que inactiva usuarios
 *
 * @version 1.0.0
 * @author equijano
 * @since 29/11/2019
...
public class SchedulerLog
{
    ...
    private static final String project = "SecurityNT";
    ...
    private static Logger getLogger()
    {
        if (logger == null)
        {
            try
            {
                folder = SchedulerLog.class.getSimpleName();
                logger = LogManager.getLogger(SchedulerLog.class);
            ...
            {
                java.util.logging.Logger.getLogger(SchedulerLog.class.getName()).log(Level.SEVERE, null, e);
            }
        }
        return logger;
    }
    ...
    {
        System.err.println("Se registro un error en " + SchedulerLog.class.getSimpleName());
