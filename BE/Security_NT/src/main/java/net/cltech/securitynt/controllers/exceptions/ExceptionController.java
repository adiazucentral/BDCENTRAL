 ...
 */
package net.cltech.securitynt.controllers.exceptions;

import java.sql.SQLException;
import java.util.List;
import net.cltech.securitynt.domain.exception.WebException;
import net.cltech.securitynt.service.interfaces.exception.ExceptionService;
...
public class ExceptionController
{
    ...
    //--------------REGISTRAR ERRORES DE FRONT-END------------
    @ApiMethod(
            description = "Registra errores no controlados del front-end.",
            path = "/api/exceptions",
            visibility = ApiVisibility.PUBLIC,
            verb = ApiVerb.POST,
    ...
    public ResponseEntity<WebException> registerException(@ApiBodyObject(clazz = WebException.class) @RequestBody WebException webException) throws Exception
    {
        return new ResponseEntity<>(service.registerException(webException), HttpStatus.OK);
    }
}
