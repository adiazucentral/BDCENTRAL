...
/**
 * Representa el log para la integracion con el sistema de licenciamiento
 *
 * @version 1.0.0
 * @author equijano
 * @since 25/10/2019
...
public class LicenseLog
{
    ...
    private static Logger getLogger()
    {
        if (logger == null)
        {
            try
            {
                folder = LicenseLog.class.getSimpleName();
                logger = LogManager.getLogger(LicenseLog.class);
            ...
            {
                java.util.logging.Logger.getLogger(LicenseLog.class.getName()).log(Level.SEVERE, null, e);
            }
        }
        return logger;
    }
    ...
    {
        System.err.println("Se registro un error en " + LicenseLog.class.getSimpleName());
