 ...
 */
package net.cltech.securitynt.dao.impl.postgresql.masters.demographic;
...
public class BranchDaoPostgreSQL implements BranchDao
{
    ...
    public Branch update(Branch branch) throws Exception
    {
        ...
        jdbc.update("UPDATE lab05 SET lab05c2 = ?, lab05c4 = ?, lab05c5 = ?, lab05c6 = ?, lab05c7 = ?, lab05c8 = ?, lab05c9 = ?, lab05c10 = ?, lab05c11 = ?, lab05c12 = ?, lab04c1 = ?, lab07c1 = ? "
                + "WHERE lab05c1 = ?",
                branch.getAbbreviation(), branch.getName(), branch.getAddress(), branch.getPhone(), branch.getMinimum() == null ? 0 : branch.getMinimum(), branch.getMaximum() == null ? 0 : branch.getMaximum(), timestamp, branch.getCode(), branch.getResponsable(), branch.getEmail(), branch.getUser().getId(), branch.isState() ? 1 : 0, branch.getId());
