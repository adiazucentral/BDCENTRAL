...
public class TestScript
{
    ...
    public static void createInitialOrders()
    {
        ...
        //MUESTRA
        TestScript.execTestUpdateScript("INSERT INTO lab24 VALUES (1, 'SANGRE', 1, 3, 1, 'DESCRIPCION', 10, '2017-09-11 13:48:21.775', 1, 1, 1, '1', '1,2,3,4', 1)");
        //SEDES
...
//        TestScript.execTestUpdateScript("IF NOT EXISTS(SELECT 1 FROM information_schema.sequences WHERE sequence_name = 'enterprise_nt_seq_2') THEN CREATE SEQUENCE enterprise_nt_seq_1 START WITH 2 INCREMENT BY 100; END IF;");
        ...
        //TIPO DE DOCUMENTO
        TestScript.execTestUpdateScript("INSERT INTO lab54 VALUES (1, '00', 'Predeterminado', '2017-09-11 15:54:54.863', 1, 1)");
        TestScript.execTestUpdateScript("INSERT INTO lab54 VALUES (2, 'CC', 'CEDULA DE CIUDADANIA', '2017-09-11 15:54:54.863', 2, 1)");
        TestScript.execTestUpdateScript("INSERT INTO lab54 VALUES (3, 'TI', 'TARJETA DE IDENTIDAD', '2017-09-11 15:55:06.596', 2, 1)");
        //AREAS
        ...
        TestScript.execTestUpdateScript("INSERT INTO lab21 (lab21c1,lab21c2,lab21c3,lab21c4,lab21c5,lab21c6,lab80c1,lab21c7,lab21c8,lab21c9,lab21c10,lab21c11,lab21c12,lab04c1,lab08c1,lab54c1) VALUES (2, '+Vt+MXn0jzrwl9nphyi0Qg==', 'ZXuuB0ALtx4=', 'FtkyjlkRT9s=', 'cZw3OxJ3H44=', 'X0NgViSQ9XM=', 7, '1970-04-26 18:37:00.051', 'a@b.c', '10', 50, NULL, '2017-09-08 12:23:52.153', 1, 1, 2)", null);
        TestScript.execTestUpdateScript("INSERT INTO lab21 (lab21c1,lab21c2,lab21c3,lab21c4,lab21c5,lab21c6,lab80c1,lab21c7,lab21c8,lab21c9,lab21c10,lab21c11,lab21c12,lab04c1,lab08c1,lab54c1) VALUES (3, '9ZIkjz4nWxG6pPzZcJAkxA==', 'Bde5xksvVDY=', 'DE+KoXPPz5E=', '66wiawuDLfc=', 'DE+KoXPPz5E=', 7, '2017-09-11 08:43:44.879', 'a@b.c', '0', 0, NULL, '2017-09-11 08:46:27.203', 1, 1, 3)", null);
        TestScript.execTestUpdateScript("INSERT INTO lab21 (lab21c1,lab21c2,lab21c3,lab21c5,lab21c12,lab80c1,lab04c1) VALUES (0, 'bygy+9615m4=', 'kCneGglFisE=', 'kCneGglFisE=',now(), 9, 2);", null);
        TestScript.execTestUpdateScript("ALTER SEQUENCE lab21_lab21c1_seq RESTART WITH 5;", null);
        //EXAMENES
        ...
        TestScript.execTestUpdateScript("ALTER SEQUENCE lab29_lab29c1_seq RESTART WITH 3;", null);
...
//        TestScript.execTestUpdateScript("INSERT INTO sta3(sta3c1, sta3c2, sta3c3, sta3c4, sta3c5, sta3c6, sta3c7, sta3c8, sta3c9, sta3c10, sta3c11, sta3c12, sta3c13, sta3c14, sta2c1, sta3c15, sta3c16, sta3c17, sta3c18, sta3c19, sta3c20, sta3c21, sta3c22, sta3c23, sta3c24, sta3c25) VALUES (1, '01', 'prueba de sangres', 2, 'QM', 'QUIMICA', 1, '1', 'laboratorio general', 0, 0, 0, 0, 0, 201906101, null, 34, 0, '', '', null, null, null, 0, 0, 0);");
    ...
    public static void createInitialInterview()
    {
        //Usuario
        TestScript.execTestUpdateScript("INSERT INTO lab04 (lab04c1, lab04c2, lab04c3,lab04c4,lab04c5,lab07c1,lab04c6,lab04c7,lab04c8, lab04c9,lab04c1_1,lab04c10,lab04c11,lab04c12,lab04c13,lab04c14,lab04c15,lab04c16,lab04c17,lab04c18, lab04c19, lab04c20,lab04c21,lab04c22,lab04c23,lab04c24,lab103c1,lab04c25,lab04c26,lab04c27, lab04c28,lab04c29) "
                + "VALUES (6, 'Pruebas SAS', 'User', 'lismanagers77', '9AVAz9/hWlkxiGca+0hOTQ==', 1, '2020-04-01 15:15:23.327045','2020-04-01 15:15:23.327045','2020-04-01 15:15:23.327045','2020-04-01 15:15:23.327045',null,null,null,null,null,0,11,null,0,0,0,0,0,0,0,0,null,null,'2020-04-01 15:15:23.327045',null,null,0)");
        //Pregunta
        TestScript.execTestUpdateScript("INSERT INTO lab70(lab70c1,lab70c2,lab70c3,lab70c4,lab70c5,lab70c6,lab04c1,lab07c1)"
                + " VALUES (7, 'FUMADO', '¿Ha Fumado En Las Ultimas 48 Horas?', 0, 5, '2020-09-13 11:24:27.468', 2, 1) ");
        //Respuesta
        TestScript.execTestUpdateScript("INSERT INTO lab90(lab90c1,lab90c2,lab90c3,lab04c1,lab07c1)"
                + " VALUES (7, 'TAL VEZ', '2020-09-13 11:24:27.468', 2, 1) ");
        //Entrevista - Orden
        TestScript.execTestUpdateScript("INSERT INTO lab23(lab22c1,lab70c1,lab90c1,lab23c1,lab23c2,lab04c1,lab70c5) "
                + "VALUES (201709080001, 7, 7, null, '2020-09-13 11:24:27.468', 6, 5) ");
    }
    
    public static void createInitialCases()
    {        
        TestScript.deleteData("pat14");
        TestScript.deleteData("pat15");
        TestScript.deleteData("pat13");
        TestScript.deleteData("pat01");
        TestScript.deleteData("pat03");
        TestScript.deleteData("pat07");
        TestScript.deleteData("pat05");
        TestScript.deleteData("pat02");
        TestScript.deleteData("pat10");
        TestScript.deleteData("pat11");
        TestScript.deleteData("pat12");
        
        //Tipos de estudio
        TestScript.execTestUpdateScript("INSERT INTO pat11 (pat11c1, pat11c2, pat11c3, pat11c4, pat11c5, lab04c1a, pat11c6, lab04c1b) VALUES(1, 'B', 'BIOLOGIA MOLECULAR',1,'now()', 1, null, null)", null);
        
        //Estudios tipos de estudio
        TestScript.execTestUpdateScript("INSERT INTO pat12 (pat12c1, pat11c1, lab39c1) VALUES(1, 1, 6)", null);
        
        //Casetes
        TestScript.execTestUpdateScript("INSERT INTO pat03 (pat03c1, pat03c2, pat03c3, pat03c4, pat03c5, pat03c6, lab04c1a, pat03c7, lab04c1b) VALUES(1, 'VER', 'Verde',1, '#ffffff', 'now()', 1, null, null)", null);
        
        //Organo
        TestScript.execTestUpdateScript("INSERT INTO pat07 (pat07c1, pat07c2, pat07c3, pat07c4, pat07c5, lab04c1a, pat07c6, lab04c1b) VALUES(1, 'HUE', 'HUESO', 1,'now()', 1, null, null)", null);
      
        //Contenedor
        TestScript.execTestUpdateScript("INSERT INTO pat05 (pat05c1, pat05c2, pat05c3, pat05c4, pat05c5, lab04c1a, pat05c6, lab04c1b) VALUES(1, 'LAMINA', null, 1,'now()', 1, null, null)", null);
        
        //Area
        TestScript.execTestUpdateScript("INSERT INTO pat02 (pat02c1, pat02c2, pat02c3, pat02c4, pat02c5, lab04c1a, pat02c6, lab04c1b) VALUES(1, 'MIC', 'MICROSCOPIA', 1,'now()', 1, null, null)", null);
        
        //Fijadores
        TestScript.execTestUpdateScript("INSERT INTO pat10 (pat10c1, pat10c2, pat10c3, pat10c4, pat10c5, lab04c1a, pat10c6, lab04c1b) VALUES(1, 'FOR', 'FORMOL', 1,'now()', 1, null, null)", null);
        
        //Caso
        TestScript.execTestUpdateScript("INSERT INTO pat01 (pat01c1, pat01c2, pat11c1, pat01c3, lab22c1, pat01c4, lab05c1, lab04c1a, pat01c5, lab04c1b, pat01c6, lab04c1c) VALUES(1, 202103030001,1,20210303,201710040010, 1,2,1,'now()',null, null, 1)", null);
       
        //Caso - Especimenes
        TestScript.execTestUpdateScript("INSERT INTO pat13 (pat13c1, pat01c1, lab24c1, pat04c1, pat07c1) VALUES( 1, 1, 1, null, 1)", null);

        //Muestras
        TestScript.execTestUpdateScript("INSERT INTO pat14 (pat14c1, pat14c2, pat05c1, pat10c1, pat13c1) VALUES(1,1,1,1,1)", null);
        
        //Estudios
        TestScript.execTestUpdateScript("INSERT INTO pat15 (pat13c1, lab39c1) VALUES(1,6)", null);
