...
/**
 * Prueba unitaria sobre el api rest /api/modules
 *
 * @version 1.0.0
 * @author enavas
 * @since 31/05/2017
...
public class ModuleTest
{
    ...
    @Test
    public void test_01_getallModule() throws Exception
    {
    ...
    @Test
    public void test_02_getUserModules() throws Exception
    {
        mockMvc.perform(get("/api/modules/filter/user/" + 1)
                .header("Authorization", token))
                .andExpect(status().isOk());
    }
