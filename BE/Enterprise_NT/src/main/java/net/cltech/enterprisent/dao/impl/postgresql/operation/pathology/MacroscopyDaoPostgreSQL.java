...
/**
 * Realiza la implementación del acceso a datos de información de las descripciones macroscopicas de los casos de patologia
 * para PostgreSQL
 *
 * @version 1.0.0
 * @author omendez
 ...
 */
@Repository
public class MacroscopyDaoPostgreSQL implements MacroscopyDao
{
