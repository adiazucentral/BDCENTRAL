 ...
 */
@Repository
public class IntegrationEpidemiologyDaoSQLServer implements IntegrationEpidemiologyDao
{
    ...
    public List<EpidemiologicalEvents> getTestsByArea(int area) throws Exception
    {
        try
        {
            ...
            query.append("SELECT lab39c1, lab39c2, lab39c3, lab66.lab44c1, lab44c2  ")
                    .append(" FROM lab39 ")
                    .append(" LEFT JOIN lab66 ON lab39.lab39c1 = lab66.lab66c1 ").append(" AND lab66.lab44c1 = ( SELECT TOP 1 MIN(lab44c1) as lab44c1 FROM lab66 WHERE lab66c1 = lab39.lab39c1)")
