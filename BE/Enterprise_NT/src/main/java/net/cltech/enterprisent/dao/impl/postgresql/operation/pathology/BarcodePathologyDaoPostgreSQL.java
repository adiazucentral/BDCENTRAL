...
/**
 * Realiza la implementación del acceso a datos de información del codigo de barras de patologia
 * para PostgreSQL
 *
 * @version 1.0.0
 * @author omendez
 ...
 */
@Repository
public class BarcodePathologyDaoPostgreSQL implements BarcodePathologyDao 
{
