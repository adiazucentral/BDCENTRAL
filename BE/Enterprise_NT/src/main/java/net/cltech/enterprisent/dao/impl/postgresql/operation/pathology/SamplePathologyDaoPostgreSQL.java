...
/**
 * Realiza la implementación del acceso a datos de información de las muestras de los casos de patologia
 * para PostgreSQL
 *
 * @version 1.0.0
 * @author omendez
 ...
 */
@Repository
public class SamplePathologyDaoPostgreSQL implements SamplePathologyDao
{
