...
/**
 * Realiza la implementación del acceso a datos de información de las ordenes de patologia
 * para PostgreSQL
 *
 * @version 1.0.0
 * @author omendez
 ...
 */
@Repository
public class OrderPathologyDaoPostgreSQL implements OrderPathologyDao
{
    ...
    public List<OrderPathology> list(final ResultFilter resultFilter, boolean orderByOrderId, Integer branch) throws Exception
    {
        try
        {
            ...
            where.append(" WHERE '4' = any(string_to_array(lab24c10, ',')::text[]) ");
            where.append( " AND lab22.lab05c1 = ? AND lab22.lab07c1 = 1 AND (lab22c19 = 0 or lab22c19 is null) ");
