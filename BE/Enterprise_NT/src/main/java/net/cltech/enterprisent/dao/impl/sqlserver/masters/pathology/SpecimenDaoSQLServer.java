...
/**
 * Realiza la implementación del acceso a datos de información de los especimenes de patología
 * para SQLServer
 *
 * @version 1.0.0
 * @author etoro
 ...
 */
@Repository
public class SpecimenDaoSQLServer implements SpecimenDao {
    ...
    public List<Specimen> list() throws Exception
    {
        try
        {
            return jdbc.query(""
                    ...
                    + "WHERE (CHARINDEX('4', lab24c10 ) > 0) ", (ResultSet rs, int i) ->  
            {
