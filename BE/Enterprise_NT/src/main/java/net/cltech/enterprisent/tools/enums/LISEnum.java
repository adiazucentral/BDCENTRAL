package net.cltech.enterprisent.tools.enums;
...
public class LISEnum
{
     ...
     * Estados de la muestra
     */
    public enum SampleStateHomebound
    {
        PRINT(5),
        TRANSPORT(6);
        ...
        SampleStateHomebound(int value)
        {
            this.value = value;
        }
    ...
    /**
     * Origen del modulo que llama al servicio
     */
    ...
    {
        GENERAL(1), PENDING(2), CONFIDENTIAL(3);

        private final Integer value;

        RackType(Integer value)
        {
            this.value = value;
        }
    ...
    {
        OPEN(0), CLOSED(1), DISPOSED(2);

        private final Integer value;

        RackState(Integer value)
        {
            this.value = value;
        }
    ...
    /**
     * Estados del envio por correo
     */
    public enum MailSendinType
    {
        MANUALLY(0),
        AUTOMATIC(1);
