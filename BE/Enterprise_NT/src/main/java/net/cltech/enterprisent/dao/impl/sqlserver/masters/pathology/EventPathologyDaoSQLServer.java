...
/**
 * Realiza la implementación del acceso a datos de información de los eventos de patología
 * para SQLServer
 *
 * @version 1.0.0
 * @author omendez
 ...
 */
@Repository
public class EventPathologyDaoSQLServer implements EventPathologyDao
{
