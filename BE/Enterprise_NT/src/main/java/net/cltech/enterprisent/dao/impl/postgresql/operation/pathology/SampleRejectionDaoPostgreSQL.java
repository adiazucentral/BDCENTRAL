...
/**
 * Realiza la implementación del acceso a datos de información de las muestras rechazadas de patologia
 * para PostgreSQL
 *
 * @version 1.0.0
 * @author omendez
 ...
 */
@Repository
public class SampleRejectionDaoPostgreSQL implements SampleRejectionDao 
{
