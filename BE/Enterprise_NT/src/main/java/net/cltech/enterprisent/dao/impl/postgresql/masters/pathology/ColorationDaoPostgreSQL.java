...
/**
 * Realiza la implementación del acceso a datos de información de las coloraciones de patologia
 * para PostgreSQL
 *
 * @version 1.0.0
 * @author omendez
 ...
 */
@Repository
public class ColorationDaoPostgreSQL implements ColorationDao
{
