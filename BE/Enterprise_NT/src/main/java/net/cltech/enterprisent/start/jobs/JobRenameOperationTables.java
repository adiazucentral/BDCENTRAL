...
/**
 * Tarea programada para renombrar todas las tablas de operación sus llaves
 * primarias e index
 *
 * @version 1.0.0
 * @author javila
 ...
 * @see Creación
 */
public class JobRenameOperationTables implements Job
{
    ...
    public void execute(JobExecutionContext job) throws JobExecutionException
    {
        try
        {
            configurationService.renameOperationTablesByYear();
