...
/**
 * Clase que representa la informacion de las coloraciones de Patologia
 *
 * @version 1.0.0
 * @author omendez
 * @since 07/04/2021
...
@ApiObject(
        group = "Patología",
        name = "Coloracion",
        description = "Muestra informacion del maestro de coloraciones de patologia que usa el API"
)
@JsonInclude(JsonInclude.Include.NON_NULL)
public class Coloration extends PathologyAudit 
{
