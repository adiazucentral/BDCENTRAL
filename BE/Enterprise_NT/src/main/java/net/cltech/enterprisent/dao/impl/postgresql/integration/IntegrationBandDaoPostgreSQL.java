 ...
 */
@Repository
public class IntegrationBandDaoPostgreSQL implements IntegrationBandDao
{
    ...
    public List<Long> ordersOfTheDay() throws Exception
    {
        try
        {
            ...
            query.append("SELECT lab22c1 ")
                    .append("FROM lab22 ")
                    .append("WHERE lab22c3::date = now()::date AND lab22.lab07c1 = 1 AND (lab22c19 = 0 or lab22c19 is null) ");
