 ...
 */
@Repository
public class DemographicDaoSQLServer implements DemographicDao
{
    ...
    public Demographic create(Demographic demographic) throws Exception
    {
        ...
        parameters.put("lab63c1", demographic.getDemographicItem());
    ...
    public Demographic get(Integer id, String name, Integer sort) throws Exception
    {
        try
        {
            ...
            String query = "SELECT lab62c1, lab62c2, lab62c3, lab62c4, lab62c5, lab62c6, lab62c7, lab62c8, lab62c9, lab62c10, lab62c11, lab62c12, lab62c15, lab62.lab07c1, lab62.lab04c1, lab04c2, lab04c3, lab04c4, lab62c13, lab63c1 "
                    + "FROM lab62 "
    ...
    public Demographic update(Demographic demographic) throws Exception
    {
        ...
        jdbc.update("UPDATE lab62 SET lab62c2 = ?, lab62c3 = ?, lab62c4 = ?, lab62c5 = ?, lab62c6 = ?, lab62c7 = ?, lab62c8 = ?, lab62c9 = ?, lab62c10 = ?, lab62c11 = ?, lab62c12 = ?, lab04c1 = ?, lab07c1 = ?, lab62c13 = ?, lab62c14 = ?, lab62c15 = ?, lab63c1 = ? "
                + "WHERE lab62c1 = ?",
                demographic.getName(), demographic.getOrigin(), demographic.isEncoded() ? 1 : 0, demographic.getObligatory(), demographic.getOrdering(), demographic.getFormat(), demographic.getDefaultValue(), demographic.isStatistics() ? 1 : 0, demographic.isLastOrder() ? 1 : 0, demographic.isCanCreateItemInOrder() ? 1 : 0, timestamp, demographic.getId(), demographic.isState() ? 1 : 0, demographic.isModify() ? 1 : 0, demographic.getDefaultValueRequired(), demographic.isPromiseTime()? 1 : 0, demographic.getDemographicItem(), demographic.getId());
