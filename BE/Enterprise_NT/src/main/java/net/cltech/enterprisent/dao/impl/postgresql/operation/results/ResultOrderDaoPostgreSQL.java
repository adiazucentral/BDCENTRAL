 ...
 */
@Repository
public class ResultOrderDaoPostgreSQL implements ResultOrderDao
{
    ...
    public void updateReference(UpdateResult updateResult, int valueSample) throws Exception
    {
        try
        {
            String query = ISOLATION_READ_UNCOMMITTED + "SELECT  lab39.lab24c1 AS lab24c1 FROM lab39 WHERE lab39.lab39c1 = ? ";
