...
/**
 * Realiza la implementación del acceso a datos de información del procesador de tejidos de los casetes de las muestras de un caso de patologia
 * para PostgreSQL
 *
 * @version 1.0.0
 * @author omendez
 ...
 */
@Repository
public class TissueProcessorDaoPostgreSQL implements TissueProcessorDao
{
