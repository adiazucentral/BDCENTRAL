 ...
 */
@Repository
public class PatientsDaoPostgreSQL implements PatientsDao
{
    ...
    public List<Patient> listPatientsByPag(PatientReport patientReport) throws Exception
    {
        ...
        where.append(" ORDER BY lab21c1 ASC ");

        // parameters.add(((patientReport.getPage() - 1) < 0 ? 0 : (patientReport.getPage() - 1)) * patientReport.getSizePage()); // Valor desde el cual se comienza pagina anterior * tamño de la pagina = registro siguiente
