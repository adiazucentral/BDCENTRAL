...
/**
 * Realiza la implementación del acceso a datos de información de resultados
 * PostgreSQL
 *
 * @version 1.0.0
 * @author eacuna
 ...
 */
@Repository
public class ResultDaoPostgreSQL implements ResultDao
{
     ...
     * otra de finalización solo ordenes ya validadas dentro de esas fechas
     *
     * @param startDate
     * @param endDate
    ...
    public List<Long> rangeOrders(String startDate, String endDate) throws Exception
    {
        try
        {
            ...
            query.append("SELECT lab22c1 ")
                    .append("FROM lab57 ")
                    .append("WHERE lab57c2::date BETWEEN ?::date")
                    .append(" AND ?::date AND lab57c8 = 4");
