 ...
 */
@Repository
public class IntegrationSklDaoSQLServer implements IntegrationSklDao{
    ...
    public String listCommentPatient(int idPatient) {
        try {
            return getJdbcTemplate().queryForObject(""
                    + "SELECT top 1 lab60c1, lab60c2, lab60c3, lab60c4, lab60c5, lab60c6, lab60.lab04c1, lab04c2, lab04c3, lab04c4 "
                    + "FROM lab60 "
                    + "INNER JOIN lab04 ON lab04.lab04c1 = lab60.lab04c1 "
                    + "WHERE lab60c2 = ? AND lab60c4 = 2",
