...
/**
 * Realiza la implementación del acceso a datos de información del codigo de barras para patologia
 * para SQLServer
 *
 * @version 1.0.0
 * @author omendez
 ...
 */
@Repository
public class BarcodePathologyDaoSQLServer implements BarcodePathologyDao
{
