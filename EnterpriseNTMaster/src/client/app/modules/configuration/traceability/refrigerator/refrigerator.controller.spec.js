...
describe('RefrigeratorController', function() {
  ...
  beforeEach(function() {
    bard.appModule('app.refrigerator');
  ...
  beforeEach(function() {
    ...
    controller = $controller('RefrigeratorController');

  });

  describe('refrigerator controller', function() {
    it('should be created successfully', function() {
      expect(controller).to.be.defined;
    });

  describe('after activate', function() {
     it('should have title of refrigerator', function() {
       expect(controller.title).to.equal('Refrigerator');
      });
