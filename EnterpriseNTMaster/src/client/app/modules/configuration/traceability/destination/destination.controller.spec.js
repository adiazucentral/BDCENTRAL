...
describe('DestinationController', function () {
    ...
    beforeEach(function () {
        bard.appModule('app.destination');
    ...
    describe(' destination controller', function () {
        it('should be created successfully', function () {
            expect(controller).to.be.defined;
        });
        describe('after activate', function () {
            it('should have title of destination', function () {
                expect(controller.title).to.equal('Destination');
            });
        });
    });
});
