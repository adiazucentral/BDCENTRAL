/* jshint -W117, -W030 */
describe('SpecialtyController', function() {
  var controller;
  //var people = mockData.getMockPeople();

  beforeEach(function() {
    bard.appModule('app.specialty');
  ...
  describe('specialty controller', function() {
    it('should be created successfully', function() {
      expect(controller).to.be.defined;
    });

  describe('after activate', function() {
     it('should have title of specialty', function() {
       expect(controller.title).to.equal('Specialty');
      });
