...
describe('paymenttypesController', function () {
    ...
    beforeEach(function () {
        bard.appModule('app.paymenttypes');
    ...
    beforeEach(function () {
        ...
        controller = $controller('paymenttypesController');

    });

    describe('paymenttypes controller', function () {
        it('should be created successfully', function () {
            expect(controller).to.be.defined;
        });
        describe('after activate', function () {
            it('should have title of paymenttypes', function () {
                expect(controller.title).to.equal('paymenttypes');
            });
        });
    });
});
