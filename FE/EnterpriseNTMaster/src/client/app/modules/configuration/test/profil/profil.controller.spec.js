/* jshint -W117, -W030 */
describe('ProfilControllerController', function () {
    var controller;
    //var people = mockData.getMockPeople();

    beforeEach(function () {
        bard.appModule('app.profil');
    ...
    describe('ProfilController controller', function () {
        ...
        describe('after activate', function () {
            it('should have title of LiteralResult', function () {
                expect(controller.title).to.equal('Profil');
            });
