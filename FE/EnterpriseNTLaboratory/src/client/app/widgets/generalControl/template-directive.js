            ...
            function ($timeout) {
                return {
                    ...
                    controller: function ($scope, $element) {
                        ...
                        $scope.$watch('inputdisabled', function () {
                            var $elem = $($element);
                            $elem.prop('disabled', $scope.inputdisabled);
                            if ($scope.inputdisabled) {
                                $elem.closest('.md-input-wrapper').addClass('md-input-wrapper-disabled');
                            }
                            else {
                                $elem.closest('.md-input-wrapper').removeClass('md-input-wrapper-disabled');
                            }
                        });
                    },
            ...
            function () {
                return {
                    ...
                    link: function (scope, element, attrs) {
                        ...
                        var chart = angular.element(span).peity("line", options);
            ...
            function () {
                return {
                    ...
                    link: function (scope, element, attrs) {
                        ...
                        var chart = angular.element(span).peity("pie", options);
            ...
            function () {
                return {
                    ...
                    link: function (scope, element, attrs) {
                        ...
                        var chart = angular.element(span).peity("donut", options);
            ...
            function () {
                return {
                    ...
                    link: function (scope, element, attrs) {
                        ...
                        var chart = angular.element(span).peity("bar", options);
        ...
        .directive('mdPreloader', [
            function () {
                return {
                    ...
                    template: '<div ><img src="../images/loading.gif" ng-attr-height="{{ height }}" ng-attr-width="{{ width }}"></div>',
                    link: function (scope, elem, attr) {

                        scope.width = scope.width ? scope.width : 90;
                        scope.height = scope.height ? scope.height : 90;
        ...
        .directive('preloader', [
            ...
            function ($rootScope, utils) {
                return {
                    ...
                    template: '<img src="images/img/spinners/{{style}}{{imgDensity}}.gif" alt="" ng-attr-width="{{width}}" ng-attr-height="{{height}}">',
                    link: function (scope, elem, attrs) {
