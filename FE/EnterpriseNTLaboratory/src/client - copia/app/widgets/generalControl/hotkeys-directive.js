...
(function () {
	...
	angular.module('app.widgets')
		...
		.directive('hotkey', ['$parse', '$hotkey', 'HotKeysElement', function ($parse, $hotkey, HotKeysElement) {
			return {
				restrict: 'AE',
		...
		.factory('HotKeysElement', ['$window', 'HotKeys', function ($window, HotKeys) {
		...
		.factory('HotKeys', ['ParseKey', '$rootScope', function (ParseKey, $rootScope) {
		...
		.factory('$hotkey', ['$window', 'HotKeysElement', function ($window, HotKeysElement) {
			return HotKeysElement($window);
		}])

		.service('ParseKey', ['$window', function ($window) {
